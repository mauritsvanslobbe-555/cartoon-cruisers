...
import { Screen, BigButton, BackButton, Icon, Confetti } from '../ui';
...
export default function ResultScreen({ scene, ownedHorn, resultImage, onRestart, onOpenShop }: ResultScreenProps) {
  ...
  return (
    <Screen bg={COLORS.cream} style={{ padding: '64px 18px 28px' }}>
      ...
      <div style={{ marginTop: 56, textAlign: 'center' }}>
        ...
        <h2 style={{
          ...
          fontSize: 26, color: COLORS.ink, margin: '10px 0 4px',
